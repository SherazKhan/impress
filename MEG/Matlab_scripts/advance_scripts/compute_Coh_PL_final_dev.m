function compute_Coh_PL_final_dev(cfg,subj,freq,label_name,nepochs,label_dir,data_dir,inv_dir)
...
ind=[1:2,6:length(label_name)-6];

tt=load([data_dir 'Time_Freq/' subj '_cortex_inv_fixed_all_sensors_ds_cond1_cond2_freq_' label_name(ind) '_' num2str(freq(1)) '_' num2str(nepochs) 'rightepochs.mat']);

Coh_A=tt.Coh_A;
nepochs_A=tt.nepochs_A;
