function cluster2D_eval_withinROI(Stats,Times,freq,cfg,G1,G2)
...
%             saveas(gca,[cfg.save_fig cfg.save_tag '_' tag '_cluster' num2str(iclus)],'png')
            ...
            title([cfg.g1tag ' pvalue=' num2str(pval)],'fontsize',18,'fontweight','bold')
            ...
            title([cfg.g2tag ' pvalue=' num2str(pval)],'fontsize',18,'fontweight','bold')
