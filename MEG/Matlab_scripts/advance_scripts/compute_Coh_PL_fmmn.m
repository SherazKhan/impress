function compute_Coh_PL_fmmn(subj,visitNo,freq,label_name,nepochs,label_dir)
...
save([save_dir 'Time_Freq/' subj '_cortex_inv_fixed_all_sensors_ds_cond1_cond2_freq_' label_name(1:end-6) '_' num2str(freq(1)) '-' num2str(freq(end)) '_' num2str(nepochs) 'epochs.mat'],...
    'PL_B','PL_A','Coh_B','Coh_A','Z_PL','Z_Coh','freq','label_name','nepochs_A','nepochs_B');

stemPL=[save_dir 'Time_Freq/' subj '_cortex_inv_fixed_all_sensors_ds_cond1_cond2_freq_PL_' label_name(1:end-6) '_' num2str(freq(1)) '-' num2str(freq(end)) '-' num2str(nepochs) 'epochs'];
stemCoh=[save_dir 'Time_Freq/' subj '_cortex_inv_fixed_all_sensors_ds_cond1_cond2_freq_Coh_' label_name(1:end-6) '_' num2str(freq(1)) '-' num2str(freq(end)) '-' num2str(nepochs) 'epochs'];
